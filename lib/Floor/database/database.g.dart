...
class _$AppDatabase extends AppDatabase {
    ...
    final databaseOptions = sqflite.OpenDatabaseOptions(
      ...
      onCreate: (database, version) async {
        await database.execute(
            'CREATE TABLE IF NOT EXISTS `User` (`id` INTEGER PRIMARY KEY AUTOINCREMENT, `mobile` TEXT, `name` TEXT, `surname` TEXT)');
  ...
  @override
  UserDao get userDoa {
    return _userDoaInstance ??= _$UserDao(database, changeListener);
  }
}
